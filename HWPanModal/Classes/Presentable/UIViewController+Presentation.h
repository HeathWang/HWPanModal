 ...
 */
- (void)hw_panModalTransitionTo:(PresentationState)state NS_SWIFT_NAME(panModalTransitionTo:);

/**
 * When presented ViewController has a UIScrollView,
 * Use This method to update UIScrollView contentOffset
 */
- (void)hw_panModalSetContentOffset:(CGPoint)offset NS_SWIFT_NAME(panModalSetContentOffset:);
